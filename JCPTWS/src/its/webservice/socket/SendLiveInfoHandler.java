...
public class SendLiveInfoHandler extends IoHandlerAdapter{
	
	 private final Logger log = Logger.getLogger(SendLiveInfoHandler.class.getName());
    ...
    public void exceptionCaught(IoSession session, Throwable cause)
        ...
        log.debug("pass live client session occured exception, so close it." + cause.getMessage());
    }
	
	@Override
	public void sessionCreated(IoSession session) {
		// 
		log.debug("pass live Connect to Server ["+session.getServiceAddress().toString()+"] success.");
	...
	public void messageReceived(IoSession session, Object message)
		...
		log.debug("pass live Client receive Message ..." + str);
	...
	public void sessionClosed(IoSession session) throws Exception {
		 log.debug("pass live client sessionClosed.");
	}

	@Override
	public void sessionIdle(IoSession session, IdleStatus status)
			throws Exception {
		log.debug("pass live client session idle, so disconnecting......");
        //session.close();
        session.close(true);
        log.debug("pass live client disconnected.");
	}
	
	// 
	@Override
	public void messageSent(IoSession session, Object message) throws Exception {
		 log.debug("pass live message has Sent.");
    ...
    public void sessionOpened(IoSession session) throws Exception {
		log.debug("pass live client sessionOpened.");
